...
function Cards({ title, description, images, price, id }) {
    const navigate = useNavigate()
    return (
        
        <div  style={{display:"inline-flex", }}>
        <div onClick={() => navigate(`/DetailScreen/${id}`) }  style={{borderRadius: 10,height:380, border: '1px solid rgb(191, 189, 189)', margin:10, cursor:'pointer'}}>
